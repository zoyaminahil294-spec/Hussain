              ...
              <div className="bg-white p-8 md:p-16 rounded-[3rem] border border-slate-100 shadow-xl max-w-4xl mx-auto">
                ...
                <div className="space-y-6 text-slate-600 leading-relaxed">
                  <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    <h4 className="font-black text-slate-900 text-xs uppercase tracking-widest mb-2">1. Environment Variables</h4>
                    <p className="text-sm">Vercel settings mein API_KEY lazmi set karein taake AI description kaam kare.</p>
                  </div>
                  <button onClick={() => window.open('https://vercel.com/dashboard', '_blank')} className="w-full bg-indigo-600 text-white font-black py-5 rounded-2xl uppercase text-[10px] tracking-widest shadow-xl hover:bg-indigo-700 transition-all">Open Vercel Dashboard</button>
                </div>
              </div>
            )}
          </div>
